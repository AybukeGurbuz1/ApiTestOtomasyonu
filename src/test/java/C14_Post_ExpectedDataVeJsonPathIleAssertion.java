...
public class C14_Post_ExpectedDataVeJsonPathIleAssertion {
    ...
    public void test01(){
       ...
       --> Request body
        ...
        "lastname" : "Gür",
        "totalprice" : 500,
        "depositpaid" : false,                           --> iki iç içe Json objesi var
        "bookingdates" : {
            "checkin" : "2021-06-01",
            "checkout" : "2021-06-10"
            },
       ...
       --> Expected Response Body
        ...
        "booking":{
            ...
            "lastname":"Gür",
            "totalprice":500,
            "depositpaid":false,                       --> dönen response da 3 tane iç içe Json objesi var
            "bookingdates":{
                "checkin":"2021-06-01",
                "checkout":"2021-06-10"
                },
        ...
        JsonPath responseJsonPath= response.jsonPath();
           // ilk yazilan expected ====> olusturdugumuz JSonObject : expectedData    (buradan alıyoruz expected ı)
           // ikinci yazilan actual ===> response : responseJsonPath                 (buradan alıyoruz actual ı)
